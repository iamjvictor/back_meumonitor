...
ALTER TABLE "flashcards" ADD CONSTRAINT "flashcards_teacher_id_fkey"
  FOREIGN KEY ("teacher_id") REFERENCES "teachers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "flashcards" ADD CONSTRAINT "flashcards_monitor_id_fkey"
  FOREIGN KEY ("monitor_id") REFERENCES "monitors"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "flashcards" ADD CONSTRAINT "flashcards_subject_id_fkey"
...
ALTER TABLE "flashcard_sources" ADD CONSTRAINT "flashcard_sources_flashcard_id_fkey"
  FOREIGN KEY ("flashcard_id") REFERENCES "flashcards"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "flashcard_sources" ADD CONSTRAINT "flashcard_sources_chunk_id_fkey"
